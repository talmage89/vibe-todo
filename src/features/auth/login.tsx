      ...
      <div className="w-full max-w-md space-y-8 rounded-lg bg-surface p-8">
        ...
        <div className="space-y-4">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-background px-4 py-3 font-medium text-primary text-sm transition-colors hover:bg-surface"
          >
