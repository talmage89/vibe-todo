...
export function SortableTaskItem({ task, onToggleStatus, onClick }: SortableTaskItemProps) {
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <TaskListItem task={task} onToggleStatus={onToggleStatus} onClick={onClick} />
      </div>
    </div>
  );
}
