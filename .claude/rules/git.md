...
- When you start a new branch (or switch branches in a worktree) and you intend to do any implementation work, you MUST run the `sync` skill first to ensure a consistent environment.
