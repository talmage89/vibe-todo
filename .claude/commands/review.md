...
Query for any current PRs with the label "pending". Follow the following workflow for each PR:
...
3. If necessary, check out the PR's branch in your current worktree to examine the changes locally.
